      ...
      <section>
        ...
        >
          <div className="overflow-y-auton overflow-x-hidden py-5 px-3 h-full bg-gray-200 border-r border-gray-300 dark:bg-gray-800 dark:border-gray-700">
            <Link to="/">
              <p className="flex items-center sm:ml-12 lg:ml-0 md:mb-0 mr-3 mt-4 px-2 py-3">
            ...
            <ul className="space-y-2 mt-5 font-raleway md:mb-14">
              <li>
                <Link to="/dashboard">
                  <p className="flex items-center p-3 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group bg-gray-300 dark:bg-gray-700">
              ...
              <li>
                <Link to="/dashboard">
                  <p className="flex items-center p-3 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
              ...
              <li>
                <Link to="/dashboard">
                  <p className="flex items-center p-3 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <div className="absolute bottom-0 lg:flex left-0 justify-center border-r bg-gray-200 border-gray-300 lg:px-4 xl:p-4 space-x-4 w-64 dark:bg-gray-800 z-20 font-raleway">
            <div className="w-full rounded-md px-4 py-3 flex justify-between items-center hover:bg-gray-100 dark:hover:bg-gray-700 bg-gray-300 dark:bg-gray-800">
              ...
              <Link to="/login">
                <p className=" text-gray-500 hover:text-gray-900 p-3 cursor-pointer dark:text-gray-400 dark:hover:text-blueDeep ">
