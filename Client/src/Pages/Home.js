  ...
  return (
    <>
        ...
        >
          ...
          >
            <div className="flex flex-row px-12 ">
              <div className="px-10">
                <h1 className="font-sans font-black text-black dark:text-white text-3xl md:text-6xl lg:text-[220px] xl:text-[240px]">
      ...
      <div className="h-screen w-full">
        ...
        >
          <section className="bg-gray-300 dark:bg-gray-800 w-full min-h-screen flex items-center my-10 sm:my-0">
      ...
      <div className="h-screen w-full">
        ...
        >
          <section className="bg-gray-200 dark:bg-gray-700 w-full min-h-screen flex items-center my-10 sm:my-0">
      ...
      <div className="h-screen w-full">
        ...
        >
          <section className="bg-gray-300 dark:bg-gray-800 w-full min-h-screen flex justify-center">
            <div className="container mx-auto px-12 my-auto">
              <div className="flex items-center mb-12">
                <hr className="w-1/4  bg-gray-800 dark:bg-white" />
                <p className="font-raleway text-center font-medium text-3xl text-blueDeep dark:text-gray-200 pl-4">
                  What People have to say
                </p>
              </div>
              <div className="flex flex-row mx-auto mt-20 my-10 p-12 rounded-xl bg-gray-200 dark:bg-gray-700 shadow-2xl justify-center w-[1000px]">
      ...
      <footer className="w-full">
        ...
        >
          <section className="bg-gray-200 dark:bg-gray-700 w-full flex items-center my-10 sm:my-0">
            <div className="container sm:mx-auto px-12 md:my-20 flex flex-col justify-center">
              <div className="mt-10 mb-4">
                <div className="flex flex-row">
                  <div className="w-3/4">
                    ...
                    <p className="w-2/3 mt-6 text-grat-800 dark:text-gray-400 font-raleway font-light text-base leading-7">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Optio quaerat cumque unde hic porro dolores veritatis
                      quos, doloribus soluta nisi ea unde hic porro dolores
                      veritatis. Lorem ipsum dolor sit amet consectetur
                      adipisicing elit. Optio quaerat cumque unde hic porro
                      dolores veritatis quos.
                    </p>
                    <div className="mt-8 mb-6 flex flex-row">
              ...
              <div className="flex flex-row mt-6">
                <div className="w-1/2">
                  <p className="flex items-center text-md font-raleway font-medium text-black dark:text-gray-400">
                    ...
                    Copywright 2022. CoinSave Inc. All Rights Reserved
                  </p>
                </div>
                <div className="w-1/2 flex flex-row items-center justify-end">
                  <p className="flex">
                    ...
                    <i class="fab fa-twitter fa-2x fa-fw mx-2 hover:text-blueDeep dark:text-blueDeep"></i>
                    <i class="fab fa-linkedin fa-2x fa-fw mx-2 hover:text-blueDeep dark:text-blueDeep"></i>
                  </p>
                </div>
              </div>
            </div>
